<div class="widget widget-popular-posts">
   <h4>Project Terbaru <span class="head-line"></span></h4>
   <ul>
      ...
      <?php } ?>
      <div align="right">
         <a href="<?php echo base_url('project') ?>" class="main-button">
            <font style="color:white">Selengkapnya <i class="fa fa-angle-right"></i></font>
         </a>
      </div>
   </ul>
</div>