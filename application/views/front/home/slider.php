  ...
  <ul id="thumbnails">
    ...
    <li>
      ...
      <div class="" style="overflow:hidden">
        <img src="<?php echo base_url('assets/images/slider/').$slider->foto.$slider->foto_type?>" alt="<?php echo $slider->nama_slider ?>" class="width:100%;height:100%;object-fit:cover">
      </div>
      </a>
    </li>
    <?php } ?>
