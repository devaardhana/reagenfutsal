               ...
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <a href="<?php echo base_url() ?>">
                        <button name="hapus" type="button" class="btn btn-primary" aria-label="Left Align" title="Lanjut Booking">
                           <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Lanjut Booking
                        </button>
                     </a>
                     <?php if ($cek_keranjang != NULL) { ?>
